      ...
      <div className="bg-gradient-to-r from-cyan-900/30 to-blue-900/30 border border-cyan-500/30 rounded-lg p-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-2xl font-bold text-cyan-400">{formatMoney(calcularRendaTotal())}/5s</p>
          </div>
        </div>
      </div>
            ...
            >
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-green-400 font-bold">{formatMoney(gerador.renda)}/5s</span>
                </div>
                <div className="flex justify-between">
